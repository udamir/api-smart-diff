export const jsonSchemaTypes = ["any", "string", "number", "integer", "boolean", "null", "array", "object"] as const

export const jsonSchemaNodeMetaProps = ["deprecated", "readOnly", "writeOnly", "externalDocs"] as const
