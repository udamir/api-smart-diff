...
exports.openapi3Rules = exports.openapi3MethodRules = void 0;
...
const parametersRules = paramArrayRules({
    ...
    "/*": (param) => ({
        "/": [constants_1.nonBreaking, constants_1.breaking, constants_1.breaking],
        "/name": [constants_1.nonBreaking, constants_1.breaking, (ctx) => { var _a; return ((_a = ctx.up().before) === null || _a === void 0 ? void 0 : _a.in) === "path" ? constants_1.nonBreaking : constants_1.breaking; }],
