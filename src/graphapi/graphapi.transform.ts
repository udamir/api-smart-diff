...
export const transformGraphSchema = compareTransformationFactory(
  (value, other) => {
    if (
      typeof value !== "object" ||
      !value ||
...
export const transfromGraphSchemaDirective = compareTransformationFactory(
  (value, other) => {
    if (
      typeof value !== "object" ||
      !value ||
...
export const transformGraphApiDocument = compareTransformationFactory(
  (value, other) => {
    if (
      typeof value !== "object" ||
      !value ||
...
export const transformGraphApiDirective = compareTransformationFactory(
  (value, other) => {
    if (
      typeof value !== "object" ||
      !value ||
