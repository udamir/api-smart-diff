...
export const jsonSchemaTypeProps: Record<string, string[]> = {
  any: [
    ...jsonSchemaValidators.any,
    ...jsonSchemaCommonProps,
    ...jsonSchemaNodeMetaProps,
  ],
  boolean: [
    ...jsonSchemaValidators.boolean,
    ...jsonSchemaCommonProps,
    ...jsonSchemaNodeMetaProps,
  ],
  null: [
    ...jsonSchemaValidators.null,
    ...jsonSchemaCommonProps,
    ...jsonSchemaNodeMetaProps,
  ],
  string: [
    ...jsonSchemaValidators.string,
    ...jsonSchemaCommonProps,
    ...jsonSchemaNodeMetaProps,
  ],
  number: [
    ...jsonSchemaValidators.number,
    ...jsonSchemaCommonProps,
    ...jsonSchemaNodeMetaProps,
  ],
  integer: [
    ...jsonSchemaValidators.integer,
    ...jsonSchemaCommonProps,
    ...jsonSchemaNodeMetaProps,
  ],
  object: [
    ...jsonSchemaValidators.object,
    ...jsonSchemaCommonProps,
    ...jsonSchemaNodeMetaProps,
  ],
  array: [
    ...jsonSchemaValidators.array,
    ...jsonSchemaCommonProps,
    ...jsonSchemaNodeMetaProps,
  ],
}

export const jsonSchemaAllowedSibling = [
  "$defs",
  "definitions",
  "$schema",
  "$id",
