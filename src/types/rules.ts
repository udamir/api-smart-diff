...
export type CompareTransformResolver<T = unknown> = (
  before: T,
  after: T,
) => [T, T]

export type MappingResolver<T extends string | number> = T extends string
  ? MappingObjectResolver
...
export type ChangeAnnotationResolver = (
  diff: Diff,
  ctx: ComapreContext,
) => AnnotateTemplate | undefined
